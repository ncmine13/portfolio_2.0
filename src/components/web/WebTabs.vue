<template>
  <div class="web-tabs__wrapper">
    <web-banner-text :intro="banner"></web-banner-text>
    <div class="web-tabs__nav-wrapper site-width">
    ...
    <div class="web-tabs__project--wrapper site-width">
      <!-- <web-project v-bind:id="project.name" v-for="project in projects" :key="project.id"></web-project> -->
...
<script>
import webBannerText from './WebBannerText'
